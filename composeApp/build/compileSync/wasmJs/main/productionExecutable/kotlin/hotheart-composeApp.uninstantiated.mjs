...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const wasmFilePath = './hotheart-composeApp.wasm';
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./hotheart-composeApp.wasm',import.meta.url).href), importObject)).instance;
      }
    } catch (e) {
